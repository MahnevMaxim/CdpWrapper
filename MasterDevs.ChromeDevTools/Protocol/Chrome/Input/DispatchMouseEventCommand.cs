...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Input
{
	...
	public class DispatchMouseEventCommand: ICommand<DispatchMouseEventCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets A number indicating which buttons are pressed on the mouse when a mouse event is triggered. Left=1, Right=2, Middle=4, Back=8, Forward=16, None=0.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
