...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Audits
{
	...
	{
		/// <summary>
		/// Gets or sets The type of resource causing the mixed content issue (css, js, iframe, form,...). Marked as optional because it is mapped to from blink::mojom::RequestContextType, which will be replaced by network::mojom::RequestDestination
		/// </summary>
		...
		/// <summary>
		/// Gets or sets The mixed content request. Does not always exist (e.g. for unsafe form submission urls).
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
