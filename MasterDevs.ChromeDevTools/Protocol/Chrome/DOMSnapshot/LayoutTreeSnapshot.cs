...
namespace Mybot.ChromeDevTools.Protocol.Chrome.DOMSnapshot
{
	...
	public class LayoutTreeSnapshot
	{
		...
		/// <summary>
		/// Gets or sets Global paint order index, which is determined by the stacking order of the nodes. Nodes that are painted together will have the same index. Only provided if includePaintOrder in captureSnapshot was true.
		/// </summary>
