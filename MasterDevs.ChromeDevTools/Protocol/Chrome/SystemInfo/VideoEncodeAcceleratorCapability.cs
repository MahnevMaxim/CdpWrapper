...
namespace Mybot.ChromeDevTools.Protocol.Chrome.SystemInfo
{
	...
	public class VideoEncodeAcceleratorCapability
	{
		...
		/// <summary>
		/// Gets or sets Maximum encoding framerate in frames per second supported for this |profile|, as fraction's numerator and denominator, e.g. 24/1 fps, 24000/1001 fps, etc.
		/// </summary>
