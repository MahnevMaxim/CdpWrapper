...
namespace Mybot.ChromeDevTools.Protocol.Chrome.IO
{
	...
	public class ReadCommand: ICommand<ReadCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Seek to the specified offset before reading (if not specificed, proceed with offset following the last read). Some types of streams may only support sequential reads.
		/// </summary>
