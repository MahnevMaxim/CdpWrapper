...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.WebAuthn
{
	...
	public class Credential
	{
		...
		/// <summary>
		/// Gets or sets Relying Party ID the credential is scoped to. Must be set when adding a credential.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets Signature counter. This is incremented by one for each successful assertion. See https://w3c.github.io/webauthn/#signature-counter
		/// </summary>
		public long SignCount { get; set; }
		/// <summary>
		/// Gets or sets The large blob associated with the credential. See https://w3c.github.io/webauthn/#sctn-large-blob-extension (Encoded as a base64 string when passed over JSON)
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
