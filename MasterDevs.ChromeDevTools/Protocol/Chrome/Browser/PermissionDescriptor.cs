...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Browser
{
	...
	{
		/// <summary>
		/// Gets or sets Name of permission. See https://cs.chromium.org/chromium/src/third_party/blink/renderer/modules/permissions/permission_descriptor.idl for valid permission names.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets For "push" permission, may specify userVisibleOnly. Note that userVisibleOnly = true is the only currently supported type.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
