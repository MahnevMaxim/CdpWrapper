...
namespace Mybot.ChromeDevTools.Protocol.Chrome.PerformanceTimeline
{
	...
	public class TimelineEvent
	{
		...
		/// <summary>
		/// Gets or sets The event type, as specified in https://w3c.github.io/performance-timeline/#dom-performanceentry-entrytype This determines which of the optional "details" fiedls is present.
		/// </summary>
