...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class ContinueInterceptedRequestCommand: ICommand<ContinueInterceptedRequestCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets If set the requests completes using with the provided base64 encoded raw response, including HTTP status line and headers etc... Must not be set in response to an authChallenge. (Encoded as a base64 string when passed over JSON)
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
