...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class RequestWillBeSentEvent
	{
		...
		/// <summary>
		/// Gets or sets In the case that redirectResponse is populated, this flag indicates whether requestWillBeSentExtraInfo and responseReceivedExtraInfo events will be or were emitted for the request which was just redirected.
		/// </summary>
