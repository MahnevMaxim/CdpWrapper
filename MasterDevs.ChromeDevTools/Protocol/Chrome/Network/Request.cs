...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class Request
	{
		...
		/// <summary>
		/// Gets or sets Set for requests when the TrustToken API is used. Contains the parameters passed by the developer (e.g. via "fetch") as understood by the backend.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public TrustTokenParams TrustTokenParams { get; set; }
		/// <summary>
		/// Gets or sets True if this resource request is considered to be the 'same site' as the request correspondinfg to the main frame.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
