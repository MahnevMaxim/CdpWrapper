...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class SecurityDetails
	{
		...
		/// <summary>
		/// Gets or sets The signature algorithm used by the server in the TLS server signature, represented as a TLS SignatureScheme code point. Omitted if not applicable or not known.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
