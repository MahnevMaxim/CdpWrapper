...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class RequestInterceptedEvent
	{
		...
		/// <summary>
		/// Gets or sets Set if the request is a navigation that will result in a download. Only present after response is received from the server (i.e. HeadersReceived stage).
		/// </summary>
		...
		/// <summary>
		/// Gets or sets If the intercepted request had a corresponding requestWillBeSent event fired for it, then this requestId will be the same as the requestId present in the requestWillBeSent event.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
