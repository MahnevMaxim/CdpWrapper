...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class SubresourceWebBundleInnerResponseParsedEvent
	{
		...
		/// <summary>
		/// Gets or sets Bundle request identifier. Used to match this information to another event. This made be absent in case when the instrumentation was enabled only after webbundle was parsed.
		/// </summary>
