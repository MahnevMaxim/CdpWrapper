...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class TrustTokenParams
	{
		...
		/// <summary>
		/// Gets or sets Only set for "token-redemption" type and determine whether to request a fresh SRR or use a still valid cached SRR.
		/// </summary>
		public string RefreshPolicy { get; set; }
		/// <summary>
		/// Gets or sets Origins of issuers from whom to request tokens or redemption records.
		/// </summary>
