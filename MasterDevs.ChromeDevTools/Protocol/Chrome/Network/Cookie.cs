...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class Cookie
	{
		...
		/// <summary>
		/// Gets or sets Cookie partition key. The site of the top-level URL the browser was visiting at the start of the request to the endpoint that set the cookie.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public string PartitionKey { get; set; }
		/// <summary>
		/// Gets or sets True if cookie partition key is opaque.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
