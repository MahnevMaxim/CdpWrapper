...
namespace Mybot.ChromeDevTools.Protocol.Chrome.DOM
{
	...
	public class Node
	{
		...
		/// <summary>
		/// Gets or sets Pseudo element identifier for this node. Only present if there is a valid pseudoType.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets Deprecated, as the HTML Imports API has been removed (crbug.com/937746). This property used to return the imported document for the HTMLImport links. The property is always undefined now.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
