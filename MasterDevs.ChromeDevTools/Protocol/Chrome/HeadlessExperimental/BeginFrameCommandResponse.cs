...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.HeadlessExperimental
{
	...
	{
		/// <summary>
		/// Gets or sets Whether the BeginFrame resulted in damage and, thus, a new frame was committed to the display. Reported for diagnostic uses, may be removed in the future.
		/// </summary>
