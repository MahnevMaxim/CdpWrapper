...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Page
{
	...
	public class ReloadCommand: ICommand<ReloadCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets If set, the script will be injected into all frames of the inspected page after reload. Argument will be ignored if reloading dataURL origin.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
