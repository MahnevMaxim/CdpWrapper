...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Page
{
	...
	public class Frame
	{
		...
		/// <summary>
		/// Gets or sets Frame document's registered domain, taking the public suffixes list into account. Extracted from the Frame's url. Example URLs: http://www.google.com/file.html -> "google.com"               http://a.b.co.uk/file.html      -> "b.co.uk"
		/// </summary>
