...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class ExceptionDetails
	{
		...
		/// <summary>
		/// Gets or sets Dictionary with entries of meta data that the client associated with this exception, such as information about associated network requests, etc.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
