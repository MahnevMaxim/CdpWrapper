...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class CallFunctionOnCommand: ICommand<CallFunctionOnCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Whether the result should contain `webDriverValue`, serialized according to https://w3c.github.io/webdriver-bidi. This is mutually exclusive with `returnByValue`, but resulting `objectId` is still provided.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
