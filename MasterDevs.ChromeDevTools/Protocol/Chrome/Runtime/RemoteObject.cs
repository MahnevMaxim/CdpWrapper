...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class RemoteObject
	{
		...
		/// <summary>
		/// Gets or sets Object subtype hint. Specified for `object` type values only. NOTE: If you change anything here, make sure to also update `subtype` in `ObjectPreview` and `PropertyPreview` below.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets Primitive value which can not be JSON-stringified does not have `value`, but gets this property.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets WebDriver BiDi representation of the value.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
