...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.WebAudio
{
	...
	public class ContextRealtimeData
	{
		...
		/// <summary>
		/// Gets or sets The time spent on rendering graph divided by render quantum duration, and multiplied by 100. 100 means the audio renderer reached the full capacity and glitch may occur.
		/// </summary>
