...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Fetch
{
	...
	public class AuthRequiredEvent
	{
		...
		/// <summary>
		/// Gets or sets Details of the Authorization Challenge encountered. If this is set, client should respond with continueRequest that contains AuthChallengeResponse.
		/// </summary>
