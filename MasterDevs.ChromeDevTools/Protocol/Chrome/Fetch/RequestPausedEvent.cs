...
namespace Mybot.ChromeDevTools.Protocol.Chrome.Fetch
{
	...
	public class RequestPausedEvent
	{
		...
		/// <summary>
		/// Gets or sets If the intercepted request had a corresponding Network.requestWillBeSent event fired for it, then this networkId will be the same as the requestId present in the requestWillBeSent event.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
